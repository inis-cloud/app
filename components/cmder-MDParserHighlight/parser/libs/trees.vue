...
<style>
	...
	/* H */
	.__h1, .__h2, .__h3, .__h4, .__h5, .__h6{cursor: pointer;}
	.__h1, .__h2, .__h3, .__h4, .__h5, .__h6{position:relative;margin:20px 0 32px!important;}
	.__h1::after, .__h2::after, .__h3::after, .__h4::after, .__h5::after, .__h6::after{transition:all .35s;content:"";position:absolute;background:linear-gradient(#3c67bd8c 30%,#3c67bd 70%);width:1em;left:0;box-shadow:0 3px 3px rgba(32,160,255,.4);height:3px;bottom:-8px}
	.__h1::before, .__h2::before, .__h3::before, .__h4::before, .__h5::before, .__h6::before{content:"";width:100%;border-bottom:1px solid #eee;bottom:-7px;position:absolute}
	.__h1:hover::after, .__h2:hover::after, .__h3:hover::after, .__h4:hover::after, .__h5:hover::after, .__h6:hover::after{width:2.5em}
	.__h1, .__h2, .__h3, .__h4, .__h5, .__h6{color:#666;line-height:1.4;font-weight:700;margin:30px 0 10px 0}
</style>
